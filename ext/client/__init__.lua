...
local bloodSplatterSpawnRateMultiplier = 3.80 --How fast new blood splatters should be spawned
local bloodSplatterSizeMultiplier = 1.95 --The spawn area size for blood splatters
