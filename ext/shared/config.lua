...
maxBloodEffectsPerHit = 16 --Maximum amount of blood effects can be spawned per hit
maxBloodEffectsPerFrame = 5
splashRayLength = 6
...
bloodSplatterSpawnRateMultiplier = 1.35 --How fast new blood splatters should be spawned
...
dismemberArmsBeforeDeath = true --Arms can be dismembered before death, intended for zombie servers. Otherwise bots will hold floating guns.
